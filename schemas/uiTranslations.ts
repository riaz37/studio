            ...
            fields: [
                defineField({
                    ...
                    fields: [
                        ...
                        defineField({ name: "filteredEmpty", title: "Filtered Empty State", type: "string", description: "Use {tag} as a placeholder for the active tag" }),
                        ...
                        defineField({ name: "filtersAriaLabel", title: "Filters Aria Label", type: "string" }),
                        defineField({ name: "allTags", title: "All Tags", type: "string" }),
                        defineField({ name: "clearFilter", title: "Clear Filter", type: "string" }),
                        defineField({ name: "resultsSummary", title: "Results Summary", type: "string", description: "Use {start} and {end} placeholders" }),
                        defineField({ name: "previousPage", title: "Previous Page", type: "string" }),
                        defineField({ name: "nextPage", title: "Next Page", type: "string" }),
                        defineField({ name: "paginationLabel", title: "Pagination Label", type: "string" }),
                    ],
                }),
                defineField({
                    name: "detail",
