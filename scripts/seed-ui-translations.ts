...
function jsonToSanityFields(messages: any) {
    return {
        ...
        caseStudy: {
            list: {
                heroTitle: messages.CaseStudy?.list?.heroTitle,
                heroTagline: messages.CaseStudy?.list?.heroTagline,
                subtitle: messages.CaseStudy?.list?.subtitle,
                empty: messages.CaseStudy?.list?.empty,
                filteredEmpty: messages.CaseStudy?.list?.filteredEmpty,
                featured: messages.CaseStudy?.list?.featured,
                viewDetails: messages.CaseStudy?.list?.viewDetails,
                ariaLabel: messages.CaseStudy?.list?.ariaLabel,
                filterLabel: messages.CaseStudy?.list?.filterLabel,
                filtersAriaLabel: messages.CaseStudy?.list?.filtersAriaLabel,
                allTags: messages.CaseStudy?.list?.allTags,
                clearFilter: messages.CaseStudy?.list?.clearFilter,
                resultsSummary: messages.CaseStudy?.list?.resultsSummary,
                previousPage: messages.CaseStudy?.list?.previousPage,
                nextPage: messages.CaseStudy?.list?.nextPage,
                paginationLabel: messages.CaseStudy?.list?.paginationLabel,
            },
            detail: {
                loading: messages.CaseStudy?.detail?.loading,
                loadingSubtitle: messages.CaseStudy?.detail?.loadingSubtitle,
                updating: messages.CaseStudy?.detail?.updating,
                error: messages.CaseStudy?.detail?.error,
                readMore: messages.CaseStudy?.detail?.readMore,
                showLess: messages.CaseStudy?.detail?.showLess,
            },
            metadata: {
                listTitle: messages.CaseStudy?.metadata?.listTitle,
                listDescription: messages.CaseStudy?.metadata?.listDescription,
                notFoundTitle: messages.CaseStudy?.metadata?.notFoundTitle,
                notFoundDescription: messages.CaseStudy?.metadata?.notFoundDescription,
            },
        },
        metrics: {
