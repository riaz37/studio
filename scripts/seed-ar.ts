    ...
    const productsAr = [
        {
            ...
            demoTitle: "الذكاء في الحركة",
            demoSubtitle: "جرب معيار استقلالية المؤسسات.",
            ...
            challengesSubtitle: "تحديد نقاط الاحتكاك وعدم الكفاءة النظامية التي تخنق حالياً النمو وتبني الذكاء الاصطناعي في الصناعات القائمة.",
            cinematicNarrative: {
